...
const LoginRegisterBtn = () => {
  ...
  return (
    <Button className={classes.loginBtn} color="inherit">Login/Register</Button>
  )
}
...
const ChatBtn = (props) => {
  return (
    <IconButton className={props.iconBtnClass} color="inherit" aria-label="chat">
...
const AccountBtn = (props) => {
  return (
    <IconButton className={props.iconBtnClass} color="inherit" aria-label="accountButton">
...
const LoggedInActionItems = () => {
  ...
  return (
    <div className={classes.root}>
      ...
      <AccountBtn iconBtnClass={classes.iconBtn} accountBtnClass={classes.accountBtn}/>
    </div>
  );
}
